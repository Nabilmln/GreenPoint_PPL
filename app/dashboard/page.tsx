      ...
      <div className="container mx-auto flex items-center justify-center min-h-[calc(100vh-4rem)] py-8">
        <div className="w-full max-w-3xl">
          <div className="space-y-4">
            ...
            <p>500 Points → <strong className="text-green-100">Beginner Gardener</strong></p>
            <p>2000 Points → <strong className="text-green-200">Intermediate Gardener</strong></p>
            <p>5000 Points → <strong className="text-green-300">Expert Gardener</strong></p>
            <p>10000 Points → <strong className="text-green-400">Master Gardener</strong></p>
          </div>
            <input
              type="text"
