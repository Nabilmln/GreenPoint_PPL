...
export default function Dashboard() {
  ...
  const [lastClassification, setLastClassification] = useState<string | null>(
    null
  );
  ...
  const handleUpload = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        variant:
          selectedClassification.color === "red" ? "destructive" : "default",
      });
        ...
        <div className="w-full max-w-3xl">
          <div className="space-y-4">
            <h2 className="text-3xl font-bold text-center">
              Upload your plant images to gain points!
            </h2>
            ...
            <div className="text-center text-gray-600 mb-4 space-y-1">
              <p>
                500 Points → <strong>Beginner Gardener</strong>
              </p>
              <p>
                2000 Points → <strong>Intermediate Gardener</strong>
              </p>
              <p>
                5000 Points → <strong>Expert Gardener</strong>
              </p>
              <p>
                10000 Points → <strong>Master Gardener</strong>
              </p>
            </div>
            <input
              type="text"
