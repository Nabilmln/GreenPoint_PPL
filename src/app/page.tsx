    ...
    <div className="container mx-auto px-4 py-14">
      ...
      <div className="text-center mb-16 fade-in">
        <h1 className="text-5xl font-bold tracking-tight mb-4">
          ...
          <span className="text-green-600">GreenPoint</span>
        </h1>
        <p className="text-lg text-gray-700 max-w-2xl mx-auto">
          Upload your plant photos, get AI-powered health scores, and earn
          points on your journey to becoming a Garden Expert.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16 fade-in">
        <Card className="shadow-lg transition-transform transform hover:scale-105">
          <CardHeader>
            ...
            <CardDescription className="text-sm">
              Share one plant photo every day
            </CardDescription>
          </CardHeader>
        </Card>
        ...
        <Card className="shadow-lg transition-transform transform hover:scale-105">
          <CardHeader>
            ...
            <CardDescription className="text-sm">
              Get instant plant health scores
            </CardDescription>
          </CardHeader>
        </Card>
      ...
      <div className="flex justify-center gap-4 mb-24 fade-in">
        <Link href="/auth/signin">
          <Button
            className="border-green-600 text-green-600 hover:bg-green-600 hover:text-white text-lg py-2 px-4"
          >
            Get Started
          </Button>
        </Link>
        <Link href="/about">
          <Button
            className="border-green-600 text-green-600 hover:bg-green-600 hover:text-white text-lg py-2 px-4 outline"
          >
            Learn More
          </Button>
        </Link>
      ...
      <div className="fade-in flex flex-col md:flex-row items-center mb-16">
        <div className="md:w-1/2 md:pr-8">
          ...
          <p className="text-gray-600 text-base">
            Connect with fellow gardeners, share tips, and learn from each
            others experiences. Our community is here to support you on your
            gardening journey.
          </p>
        </div>
      ...
      <div className="fade-in flex flex-col md:flex-row items-center mb-16">
        ...
        <div className="md:w-1/2 md:pr-8 order-1 md:order-2 text-right">
          ...
          <p className="text-gray-600 text-base">
            With our AI-powered health scores, you can easily track the progress
            of your plants and receive personalized recommendations to improve
      ...
      <div className="fade-in flex flex-col md:flex-row items-center mb-24">
        <div className="md:w-1/2 md:pr-8">
          ...
          <p className="text-gray-600 text-base">
            As you engage with the app, you can earn points and unlock
            achievements that recognize your dedication to gardening. Get
            rewarded for your efforts and become a certified Garden Expert!
          </p>
        </div>
        <div className="md:w-1/2 md:pl-8">
          <img
      ...
      <div className="text-center mb-16 fade-in">
        ...
        <div className="max-w-4xl mx-auto text-center text-gray-600 mb-8">
          <p>
            Our AI model uses Convolutional Neural Networks (CNN), a deep
            learning method inspired by how the human eye processes visual
            information. It helps us detect plant conditions with high accuracy
      ...
      <div className="text-center max-w-3xl mx-auto mb-8 text-gray-600 italic">
        <p>
          Thanks to GreenPoint, I realized my plant was suffering from
          overwatering. Now its thriving again!
          <br />— A happy gardener 🌱
        </p>
      </div>
